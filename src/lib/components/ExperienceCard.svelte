...
>
	<div class="absolute left-0 top-5 bottom-5 w-1 rounded-r bg-teal-primary"></div>
	...
	{#if frontmatter.closingNote}
		<p class="mt-3 border-l-2 border-teal-primary/60 bg-teal-soft/50 px-3 py-2 pl-4 text-sm italic text-slate-700 ml-3">
